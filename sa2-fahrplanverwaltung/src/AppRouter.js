...
import BusLineModifyStops from "./BusLine/BusLineModifyStops";
    ...
    return <>
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/buslines/:id/modify" element={<BusLineModifyStops isStaff={isStaff} setIsStaff={setIsStaff} />} />
