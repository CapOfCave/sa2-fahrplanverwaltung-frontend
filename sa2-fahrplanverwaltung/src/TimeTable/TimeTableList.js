...
import apiService, { apiDeleteSchedule, apiGetAllSchedules } from "../api/ApiService";
...
export default function TimeTableList({ isStaff, setIsStaff }) {
  ...
  function confirmDeletion() {
    apiDeleteSchedule(editedSchedule.id)
  ...
  function refreshSchedules() {
    apiGetAllSchedules().then(result => setSchedules(result))
  }
